...
## Apple Human Interface Guidelines — Practical Addendum
...
- **Privacy & Permissions**: Request permissions just-in-time with clear value propositions.
- **Notifications**: Keep notifications actionable, timely, and configurable; avoid interruptive patterns.

## Notes

- Maintain platform conventions unless you have a strong, intentional reason to differ.
- Ensure consistency across the app: placement, terminology, states, and patterns.
- Prioritize accessibility: do not rely on color alone; support screen readers and clear focus states.
